...
public class Catalog {
    ...
    public boolean notebookIsCorrect(Notebook notebook) {
        ...
        for (Criterion criterion : criterionList) {
            ...
            } else if (criterion.property.equals("laptopType")) {
                valueNotebook = notebook.getLaptopType();

            } else if (criterion.property.equals("operatingSystem")) {
                valueNotebook = notebook.getOperatingSystem();

            } else if (criterion.property.equals("screenm")) {
                valueNotebook = notebook.getScreen();
    ...
    public Catalog(Set<Notebook> notebooks) {
        this.scanner = new Scanner(System.in);
        this.notebooks = notebooks;
    }

    public Catalog(Set<Notebook> notebooks, List<Criterion> criterionList) {
        this.scanner = new Scanner(System.in);
        this.notebooks = notebooks;
    ...
    public Map<String, String> descriptionsProperties() {
        ...
        map.put("laptopType", "Тип ноутбука");
        map.put("screen", "Диагональ экрана");
        map.put("operatingSystem", "Операционная система");
        map.put("screenResolution", "Разрешение экрана");
        map.put("price", "цена");
        ...
        while (flag) {
            ...
            if (operation.equals("3")) {
                ...
                if (criterion - 1 < 0 || criterion - 1 > properties.size() - 1) {
                    System.out.println("Значение введено некоректно");
                    continue;
                }
