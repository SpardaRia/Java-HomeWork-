...
public class BookingPresenter implements ViewObserver {
    ...
    public void changeReservationTable(int pastReservation, Date reservationDate, int tableNo, String name) {
        int newReservationNo = tableModel.changeReservationTable(pastReservation, reservationDate, tableNo, name);
